    ...
    <Layout style={styles.layout}>
      ...
      <Header style={{ ...styles.header, background: themeColor }}>
        <div style={styles.headerLeft}>
          ...
          <Tag color="green" style={{ marginLeft: 8 }}>OAuth2</Tag>
        </div>
        ...
        <div style={styles.grid}>
          ...
          >
            <Paragraph type="secondary">
              跳转到应用 A，无需重新授权，体验 OAuth2 单点登录效果。
            </Paragraph>
            ...
            <Space direction="vertical" style={{ width: '100%' }} size="middle">
              <Button
                ...
                block
                icon={<LinkOutlined />}
                onClick={() => window.__OAuth2ClientSDK__?.jumpToApp('http://localhost:3002')}
              >
                跳转到应用 A（localhost:3002）
              </Button>
